...
public class Constants {
    ...
    public static final String DATE_HOUR_FORMAT = "yyyy/MM/dd HH:mm:ss.SSS";

    public static final String DATE_FORMAT = "yyyy/MM/dd";

    public static final String ARG_DATE_FORMAT = "dd/MM/yyyy";

    public static final String ARG_DATE_HOUR_FORMAT = "dd/MM/yyyy HH:mm";
