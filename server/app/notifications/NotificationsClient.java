...
public class NotificationsClient {
    ...
    public String pushNotification(String receiverUserId, String notificationType, String message) {
        PushNotificationRequest request = new PushNotificationRequest(receiverUserId, notificationType, message);
